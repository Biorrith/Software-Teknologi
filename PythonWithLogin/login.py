...
#TODO: Make a block function, and figure out how you block a user for an ammount of time.
...
class authendicate():
    ...
    def make_profile(self, username, password):
        path_check = "Logins/" + username + ".txt"
        if(path.exists(path_check)):
            ...
            with open(file_name, 'w') as f:
                ...
                print(hashed_pass)
                sys.stdout = original_stdout # Reset the standard output to its original value
        #TODO: Make directory for storing mails
